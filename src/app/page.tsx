					...
					<div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
						<div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
							...
							<h1 className='relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl'>
								Your Image on a{' '}
								<span className='bg-blue-600 px-2 md:px-3 text-white rounded-2xl'>
									Custom
								</span>{' '}
								Phone Case
							</h1>
					...
					<div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
						<h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
							...
							<span className='relative px-2'>
								customers{' '}
								<Icons.underline className='hidden sm:block pointer-events-none absolute inset-x-0 -bottom-8 text-blue-500' />
							</span>{' '}
							say
						</h2>
							...
							<div className='flex gap-4 mt-2'>
								...
								<div className='flex flex-col'>
									...
									<div className='flex gap-1.5 items-center text-zinc-600'>
										<CheckIcon className='h-4 w-4 stroke-[3px] text-blue-600' />
						...
						<div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
							...
							<div className='text-lg leading-8'>
								<p>
									...
									last phone cases. This one has been holding up for a month now
									and{' '}
									<span className='p-0.5 bg-slate-800 text-white'>
			...
			<section>
				<MaxWidthWrapper className='py-24'>
					...
					<ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
						<li className='w-fit'>
							<CheckIcon className='h-5 w-5 text-blue-600 inline mr-1.5' />
						...
						<li className='w-fit'>
							<CheckIcon className='h-5 w-5 text-blue-600 inline mr-1.5' />5
							year print warranty
						</li>
